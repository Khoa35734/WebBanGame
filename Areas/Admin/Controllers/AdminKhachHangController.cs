...
namespace WebBanGame.Areas.Admin.Controllers
{
    ...
    public class AdminKhachHangController : Controller
    {
        ...
        public AdminKhachHangController(BanGameBanQuyenContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MaKh,TenKh,Diachi,Ngaysinh,Phone,Email,CreateDate,TenTaiKhoan,MatKhau")] KhachHang khachHang)
        {
